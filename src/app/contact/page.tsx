...
function Home() {
  ...
  <Paper elevation={3} className="team-members">
    ...
    <ul className="team-list">
      <li className="team-member">
        <Image src="/jhondoe.jpeg" width={270} height={225} alt="Team Member 1" />
      ...
      <li className="team-member">
        <Image src="/janeSmith.jpeg" width={225} height={225} alt="Team Member 2" />
  ...
  <Paper elevation={3} className="location-images">
    ...
    <div className="image-gallery">
      <Image src="/hqimage1.jpeg" width={275} height={183} alt="Location 1" className="location-image" />
      <Image src="/hqimage2.jpeg" width={275} height={183} alt="Location 2" className="location-image" />
      <Image src="/hqimage3.jpeg" width={275} height={183} alt="Location 3" className="location-image" />
    </div>
  </Paper>
</Grid>
        <Grid item xs={12}>
      <Paper elevation={3} className="privacy-policy">
        ...
        <p style={{fontSize:20}}>
          ...
          We may update our privacy policy. keep tuned on our website for the latest version.
        </p><br />
      </Paper>
    </Grid>
    </Grid>
